...
import com.example.qiangge.qiangge.BaseActivity;
import com.example.qiangge.qiangge.R;
import com.example.qiangge.util.FrescoShow;
...
public class PreviewImage extends BaseActivity implements OnPageChangeListener {
    ...
    public void InData() {
        // TODO Auto-generated method stub
        super.InData();
        index = getIntent().getIntExtra("count", 0);
    ...
    class SamplePagerAdapter extends PagerAdapter {
        ...
        public View instantiateItem(ViewGroup container, int position) {
            ...
            //FrescoShow.setImgeview(path,simpleDraweeView);
            if (dbpath != null){
